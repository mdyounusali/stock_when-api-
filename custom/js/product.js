...
$(document).ready(function() {
	...
	$("#addProductModalBtn").unbind('click').bind('click', function() {
		...
		$("#submitProductForm").unbind('submit').bind('submit', function() {
			...
			if(rate == "") {
				$("#rr").after('<p class="text-danger">Rate field is required</p>');
				$('#rr').closest('.form-group').addClass('has-error');
			}	else {
				// remov error text field
				$("#rr").find('.text-danger').remove();
				// success out for form 
				$("#rr").closest('.form-group').addClass('has-success');	  	
			}	// /else

			if(date == "") {
				$("#rate").after('<p class="text-danger">Date field is required</p>');
			...
			if(productImage && productName && quantity && date && rate && brandName && categoryName && productStatus) {
	...
	if(productId) {
		...
		$.ajax({
		  ...
		  // 		allowedFileExtensions: ["jpg", "png", "gif", "JPG", "PNG", "GIF"]
				...
				$("#editRate").val(response.rr);
				// date
				$("#editdate").val(response.rate);
				// brand name
				...
				$("#editProductForm").unbind('submit').bind('submit', function() {
					...
					if(date == "") {
						$("#editdate").after('<p class="text-danger">Rate field is required</p>');
					...
					if(productName && quantity && date && rate && brandName && categoryName && productStatus) {
						// submit loading button
