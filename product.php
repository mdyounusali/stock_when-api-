    ...
    <div class="modal-content">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
                 ...
                 <!--    <div class="form-group">
			        	<label for="editCategoryName" class="col-sm-3 control-label">Product Names: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
				   	...
				   	<div class="form-group">
			        	<label for="editProductName" class="col-sm-3 control-label">Product Names: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
			        ...
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
			           	...
			           	<div class="form-group">
			        	<label for="editQuantity" class="col-sm-3 control-label">Rate: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
